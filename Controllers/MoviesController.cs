...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"movieGenre: {movieGenre}");
            System.Diagnostics.Debug.WriteLine($"searchString: {searchString}");
            System.Diagnostics.Debug.WriteLine($"selectedYear: {selectedYear}");
            ...
            // Use LINQ to get list of release genres
